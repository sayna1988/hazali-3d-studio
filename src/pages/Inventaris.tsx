...
export default function Inventaris() {
  ...
  return <div className="inventory-page">
    <header className="inventory-hero"><div><span className="inventory-eyebrow">Productbeheer</span><h1>Catalogus</h1><p>Alles wat klaarstaat om verkocht te worden, helder op één plek.</p></div><button className="inventory-add-button" onClick={() => setFormulierOpen(true)}><Plus size={19} strokeWidth={2.4} />Nieuw product</button></header>
